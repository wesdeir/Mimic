> **This is the original Python implementation, kept as a reference.**
> Active development has moved to the C++/Dear ImGui port at the repo root
> -- see `../README.md`. This code is not maintained going forward; it's
> preserved because the C++ engine's statistics were fitted against it and
> the recordings in `../click_data/`.
...
2. **Run Mimic (from this directory):**
```cmd
cd python_legacy
python Mimic.py
```
